...
export default function Skills() {
  ...
  const backendSkills = [
    ...
    },
    {
      name: "GraphQL",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-[#E10098]">
  ...
  const toolsSkills = [
    {
      name: "Git",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-[#F05032]">
    ...
    },
    {
      name: "VS Code",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-[#007ACC]">
    ...
    },
    {
      name: "Webpack",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-[#8DD6F9]">
    ...
    },
    {
      name: "Postman",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-[#FF6C37]">
      ...
      <div className="space-y-12">
        <div>
          <motion.h3
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="text-xl font-semibold text-white mb-6 border-l-4 border-[#58a6ff] pl-3"
          >
          ...
          >
            {frontendSkills.map((skill, index) => (
              <motion.div
                ...
                className="bg-[#161b22] rounded-lg p-4 flex flex-col items-center justify-center border border-[#30363d] transition-all duration-300 group"
              >
                <div className="w-12 h-12 mb-3 flex items-center justify-center group-hover:transform group-hover:scale-110 transition-all duration-300">
                  {skill.icon}
                </div>
                <p className="text-xs text-gray-400 group-hover:text-[#58a6ff] transition-colors">{skill.name}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div>
          <motion.h3
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="text-xl font-semibold text-white mb-6 border-l-4 border-[#7ee787] pl-3"
          >
            Backend Development
          </motion.h3>
          <motion.div
          ...
          >
            {backendSkills.map((skill, index) => (
              ...
              >
                ...
                <p className="text-xs text-gray-400 group-hover:text-[#7ee787] transition-colors">{skill.name}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div>
          <motion.h3
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="text-xl font-semibold text-white mb-6 border-l-4 border-[#d2a8ff] pl-3"
          >
            Tools & Technologies
          </motion.h3>
          <motion.div
          ...
          >
            {toolsSkills.map((skill, index) => (
              <motion.div
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow: "0 0 15px rgba(210, 168, 255, 0.5)",
                  borderColor: "#d2a8ff",
                }}
                className="bg-[#161b22] rounded-lg p-4 flex flex-col items-center justify-center border border-[#30363d] transition-all duration-300 group"
              >
                ...
                <p className="text-xs text-gray-400 group-hover:text-[#d2a8ff] transition-colors">{skill.name}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
